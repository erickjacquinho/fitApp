...
## 3. Components
- [x] 3.1 Create `CalendarStrip` Component
...
- [x] 3.2 Refactor `MenuScreen` state
  - **Skill:** `frontend-developer`
...
- [x] 3.3 Pass `selectedDate` to `handleAddMeal`
  - **Skill:** `frontend-developer`
