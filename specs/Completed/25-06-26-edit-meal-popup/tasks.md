...
## - [x] Task 1: Add updateBasicInfo method to MealService
...
## - [x] Task 2: Update MealCard component to trigger onEdit
...
## - [x] Task 3: Integrate Dialog and Parent Background styling in MenuScreen
