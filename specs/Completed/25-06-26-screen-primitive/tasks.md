...
## - [x] Task 1: Create Interface and Base Structure
...
## - [x] Task 2: Implement Safe Area and Header Logic
- **Target:** `src/components/ui/screen.tsx`
...
## - [x] Task 3: Implement Scrollable and Padding Logic
- **Target:** `src/components/ui/screen.tsx`
- **Source:** `design.md` -> Component Hierarchy
...
## - [x] Task 4: Export and Validation
- **Target:** Validation
- **Source:** N/A
